...
function CheckoutPage() {
    ...
    }, [userId, cart.length, navigate, orderPlaced])
    ...
    const handleApplyCoupon = async () => {
        ...
        try {
            ...
            if (getCartTotal() < minPurchaseAmount) {
                throw new Error(`Minimum order amount for this code is ₹${minPurchaseAmount}`)
            }
    ...
    const finalTotal = (parseFloat(discountedSubtotal) + parseFloat(tax) + shipping).toFixed(2)
        ...
        return (
            <section className="checkout-section">
                <div className="order-success">
                    ...
                    <button className="btn btn-order-details" onClick={() => navigate('/profile')}>
                        View Order Details
                    </button>
                </div>
            </section>
                ...
                <div className="checkout-main">
                    <div className="tabs-navigation">
                        <button
                            ...
                            onClick={() => handleTabNavigation('shipping')}
                            type="button"
                        >
                        ...
                        <button
                            ...
                            onClick={() => handleTabNavigation('review')}
                            type="button"
                        >
                            ...
                            <div className="form-section">
                                ...
                                <div className="form-group customization-box">
                                    <label className="customization-toggle">
                                        <input
                                            id="wantsCustomization"
                                            name="wantsCustomization"
                                            type="checkbox"
                                            checked={Boolean(values.wantsCustomization)}
                                            onChange={handleChange}
                                        />
                                    ...
                                    {values.wantsCustomization && (
                                        <>
                                            <label htmlFor="customizationNote" className="form-label mt-3">
                                                Customization Details (Optional)
                                            </label>
                                            <textarea
                                                id="customizationNote"
                                                name="customizationNote"
                                                className={getInputClass('customizationNote')}
                                                value={values.customizationNote}
                                                onChange={handleChange}
                                                onBlur={handleBlur}
                                                placeholder="Example: Less sugar, blue frosting, add Happy Birthday Rahul"
                                                rows="3"
                                                maxLength="300"
                                            />
                                        </>
                                ...
                                <div className="form-row">
                                    ...
                                    <div className="form-group col-md-6">
                                        ...
                                        <select
                                            id="deliverySlot"
                                            name="deliverySlot"
                                            className={getInputClass('deliverySlot')}
                                ...
                                <button
                                    type="button"
                                    className="btn btn-primary checkout-action-btn w-100 mt-4"
                            ...
                            <div className="form-section">
                                ...
                                <div className="payment-methods">
                                    ...
                                    <label className="payment-option">
                                        ...
                                        />
                                        <span className="method-label">
                                            <i className="bi bi-wallet2"></i> UPI
                                        </span>
                                    </label>
                                    <label className="payment-option">
                                        <input
                            ...
                            <div className="form-section">
                                ...
                                <div className="promo-code-panel mt-3">
                                    ...
                                    {appliedCoupon && (
                                        <small className="text-success d-block mt-2">
                                            {appliedCoupon.discountType === 'fixed'
                                                ? `₹${Number(appliedCoupon.discountValue || 0).toFixed(2)} off applied`
                                ...
                                {values.wantsCustomization && (
                                    <div className="review-customization mt-3">
                                        ...
                                        <p>
                                            {values.customizationNote?.trim()
                                                ? values.customizationNote
                                                : 'Customer asked for customization and will confirm details later.'}
                                        </p>
                                    </div>
                                )}
