      ...
      <div className="privacy-content-shell">
        <div className="service-intro-grid">
          <article className="service-intro-card">
            ...
            <h3>Your data stays secure</h3>
            <p>We use strong safeguards to protect your account and order information.</p>
          </article>
          <article className="service-intro-card">
            <span className="eyebrow">Transparency</span>
            <h3>Clear data usage</h3>
            <p>We explain what we collect, why we collect it, and how it supports your shopping experience.</p>
          </article>
          <article className="service-intro-card">
            <span className="eyebrow">Customer Control</span>
            <h3>You choose your privacy</h3>
            <p>You can request updates, corrections, or data actions where applicable.</p>
          </article>
        </div>
        ...
        <section className="policy-section policy-section--surface">
          ...
          <p>
            ...
            on our website. This Privacy Policy explains how we collect, use,
        ...
        <section className="policy-section policy-section--surface">
          ...
          <ul>
            <li>
              <strong>Personal Data:</strong> When you register, place an order,
              or contact us, we may collect your name, email address, phone
              number, shipping address, and payment information.
            </li>
            <li>
              <strong>Automatically Collected Data:</strong> We automatically
              collect certain information about your device when you access our
              website, including IP address, browser type, and browsing history.
            </li>
            <li>
              <strong>Cookies and Tracking:</strong> We use cookies and similar
              tracking technologies to enhance your experience and understand
        ...
        <div className="service-support-cta">
          <h3>Need privacy assistance?</h3>
          <p>
            If you have questions about your data, account privacy, or policy details, contact our support team.
          </p>
